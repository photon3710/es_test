...
public class ObjectBankWrapper<IN extends CoreMap> extends ObjectBank<List<IN>> {
    ...
    private final static Pattern monthDayPattern = Pattern.compile("Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday|January|February|March|April|May|June|July|August|September|October|November|December", Pattern.CASE_INSENSITIVE);
