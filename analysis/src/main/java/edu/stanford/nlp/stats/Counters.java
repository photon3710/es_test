...
public class Counters {
     ...
     *
     * @param target  The values in this Counter will be changed throught by the
     *                multiplier
     ...
     * @param countThreshold The minimum count for an entry to be kept. Entries (strictly) less
     ...
     *
     * @param counter           The counter.
     * @param countMaxThreshold The maximum count for an entry to be kept. Entries (strictly) more
     *                          than this threshold are discarded.
     * @return The set of discarded entries.
     */
     ...
     *
     * @param citationCounts Citation counts for each of the articles written by the author.
     ...
     *                      all keys.
     * @param itemFormat    The format string for key/count pairs, where the key is first and
     ...
     * @param wrapperFormat The format string for wrapping text around the joined items, where
