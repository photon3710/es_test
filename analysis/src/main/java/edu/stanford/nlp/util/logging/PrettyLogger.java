...
public class PrettyLogger {
   ...
   */
     ...
     *
     * @param obj the object to be pretty logged
     */
     ...
     * default channel.
     *
     * @param description denote the object in the logs (via a track name, etc.).
     * @param obj         the object to be pretty logged
     */
     ...
     *
     * @param channels the channels to pretty log to
     * @param obj      the object to be pretty logged
     */
