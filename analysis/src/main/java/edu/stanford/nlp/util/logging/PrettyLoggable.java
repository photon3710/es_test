...
public interface PrettyLoggable {
     ...
     *
     * @param channels    the channels which should be logged to -- all logging calls should
     *                    use logging methods on the channels (e.g. channels.log(), etc.)
     * @param description The description of the object. It will potentially identify the
