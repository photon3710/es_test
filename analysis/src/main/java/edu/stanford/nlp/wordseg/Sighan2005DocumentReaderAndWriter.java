...
public class Sighan2005DocumentReaderAndWriter implements DocumentReaderAndWriter<CoreLabel>, LatticeWriter<CoreLabel, String, Integer>, Serializable {
    ...
    public void init(SeqClassifierFlags flags) {
        ...
        if (DEBUG)
            EncodingPrintWriter.err.println("Sighan2005DocRandW: using normalization file " + flags.normalizationTable, "UTF-8");
        ...
        public List<CoreLabel> apply(String line) {
            ...
            for (int index = 0, len = line.length(); index < len; index++) {
                ...
                if (!Character.isWhitespace(ch) && !Character.isISOControl(ch)) {
                    ...
                    wi.set(CoreAnnotations.CharacterOffsetBeginAnnotation.class, origIndex - 1);
                    // wi.set(CoreAnnotations.CharacterOffsetEndAnnotation.class, origIndex+1);
                    position++;
