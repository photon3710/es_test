...
/**
 * Factory for {@link JDCrfChineseTokenizer}
 * <p>
 ...
 * @lucene.experimental
 */
public final class JDCrfChineseTokenizerFactory extends TokenizerFactory {

    /**
     * Creates a new JDCrfTokenizerFactory
     */
    public JDCrfChineseTokenizerFactory(Map<String, String> args) {
        super(args);
        if (!args.isEmpty()) {
    ...
    public Tokenizer create(AttributeFactory factory, Reader input) {
        return new JDCrfChineseTokenizer(factory, input);
    }
}
