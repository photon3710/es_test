 ...
 * @lucene.experimental
 */
public final class JDCrfChineseAnalyzer extends Analyzer {
    ...
    private static class DefaultSetHolder {
        ...
        static CharArraySet loadDefaultStopWordSet() throws IOException {
            ...
            InputStream inputStream = JDCrfChineseAnalyzer.class.getClassLoader().getResourceAsStream(DEFAULT_STOPWORD_FILE);
            Reader reader = IOUtils.getDecodingReader(inputStream, StandardCharsets.UTF_8);
            return CharArraySet.unmodifiableSet(WordlistLoader.getWordSet(reader, STOPWORD_FILE_COMMENT, Version.LUCENE_CURRENT));
        }
    }
    ...
    /**
     * Create a new JDCrfChineseAnalyzer, using the default stopword list.
     */
    public JDCrfChineseAnalyzer() {
        this(null, true);
    }
     ...
     * Create a new JDCrfChineseAnalyzer, using the default stopword list.
     */
    public JDCrfChineseAnalyzer(Version matchVersion) {
     ...
     */
    public JDCrfChineseAnalyzer(Version matchVersion, boolean useDefaultStopWords) {
     ...
     */
    public JDCrfChineseAnalyzer(Version matchVersion, CharArraySet stopWords) {
    ...
    public TokenStreamComponents createComponents(String fieldName, Reader input) {
        ...
        tokenizer = new JDCrfChineseTokenizer(input);
        result = tokenizer;
        //TODO: somehow full width delimiter | is not filtered.
